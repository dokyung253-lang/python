...
# 문제 2: 리스트 요소 변경 및 역순 출력 리스트 colors = ["red", "green", "blue"]가 있습니다. 
# "green"을 "yellow"로 변경하고, 리스트의 요소를 역순(['blue', 'yellow', 'red'])으로 출력하시오.
colors = ["red", "green", "blue"]
colors[1] = "yellow"
print(colors[::-1])

# 문제 3: 요소 추가 및 삽입 빈 리스트 my_list = []를 생성한 후, 
# .append()를 사용하여 숫자 10, 30을 순서대로 추가하고, 
# .insert()를 사용하여 10과 30 사이에 숫자 20을 삽입하여 [10, 20, 30]을 만드시오.
my_list = []
my_list.append(10)
my_list.append(30)
my_list.insert(1, 20)
...
# 문제 5: 리스트 정렬과 포함 여부 score = [85, 95, 70, 100] 리스트를 내림차순(큰 숫자부터)으로 정렬하고, 
# 사용자로부터 숫자를 입력받아 해당 숫자가 score 리스트 안에 있는지 in 연산자를 사용하여 True/False로 출력하시오.
score = [85, 95, 70, 100]
print( score[::-1] )
...
for key, value in fruit_stock.items():
    print(key + "의 재고는 " + str(value) + "개 입니다.")

# 문제 9: 리스트 내 딕셔너리 순회 아래와 같은 리스트가 있을 때, 
# 반복문을 사용하여 각 학생의 이름과 점수를 출력하시오.
...
for student in students:
    print(student["name"] + " 학생의 점수는 " + str(student["score"]) + "점입니다.")
