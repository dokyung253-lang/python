...
print( *list_a ) # 리스트 그자체가 아닌 , 1 2 3 # 리스트는 첫번째 인덱스를 참조한다.
...
# 4. number % 3 -1   # 3구역 나누기 위해서 % 3   # -1 이유는 인덱스 0부터 표현하기위해서
